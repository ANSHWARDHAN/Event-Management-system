                ...
                <div className="relative grid gap-10 px-6 py-10 md:grid-cols-[0.9fr_1.1fr] md:px-12 lg:px-16 lg:py-16">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="mt-8 flex flex-wrap gap-3">
                            ...
                            <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-lg border border-white/15 px-5 py-3 font-semibold text-white transition hover:bg-white/10">
                                <FaLinkedin /> LinkedIn
                            </a>
                        </div>
                    </div>
